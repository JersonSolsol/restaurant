                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="stockout_origin" placeholder="Ingresar Origen..." >
                            </div>
                            <div class="form-group">
                                
                                <input type="hidden" class="form-control" id="stockout_description" placeholder="Ingresar Descripción..." >
                            </div>
                            <div class="form-group">
                               
                                <input type="hidden" class="form-control" id="stockout_destiny" placeholder="Ingresar Destino..." >
                            </div>
                            <div class="form-group">
                                
                                <input type="hidden" class="form-control" id="stockout_ruc" placeholder="Ingresar RUC..." >
                            </div>
                        </div>
                        <!-- /.box-body -->
