    ...
    <section class="content" style="background-color: white;box-shadow: 10px 10px 5px #888888;border-radius: 30px; padding: 15px; margin: 50px; min-height: 500px">
        ...
        <div class="row">
            ...
            <div class="col-xs-2">
                ...
                <input class="form-control" type="text" id="product_barcode" autofocus onchange="buscar_producto_barcode()">
            </div>
            <div class="col-xs-5">
            ...
            <div class="col-xs-3">
                <br>
                <a class="btn btn-warning" type="button" onclick="buscar_producto_barcode()" ><i class="fa fa-search"></i> Buscar</a>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-1"></div>
